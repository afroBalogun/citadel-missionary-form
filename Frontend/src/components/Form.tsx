...
const Form: React.FC<FormProps> = ({ isLocationValid, setIsLocationValid }) => {
    ...
    const onSubmit = async (data: Attendance) => {
        ...
        try {
            ...
            const errorMessage =
                error.data?.message ||
                "There was an error registering your attendance. Please try again.";
    ...
    return (
        <main className='form flex  flex-col justify-center items-center mb-10 flex-grow'>
            <div
                className='text-center h-[150px] flex flex-col justify-center items-center gap-2 transition-all duration-200
            ...
            '
            >
                <h3 className='text-[#DCA628] text-sm'>Missionary Force</h3>
            ...
            {isLocationValid ? (
                <form
                    ...
                    className='w-4/5 flex flex-col px-5 gap-2 text-xs md:text-sm md:mt-10 md:w-3/5'
                >
                    {/* First Name */}
                    ...
                    >
                        <option value='' className="text-gray-200">Select a Department</option>
                    ...
                    <button
                        type='submit'
                        className='bg-[#DCA628] p-3 text-white rounded-3xl mt-4 hover:cursor-pointer hover:scale-110 font-semibold transition-all duration-200'
                    >
                        Submit
                    </button>
                </form>
                ...
                <div className='mt-20 flex items-center flex-col justify-center gap-2 flex-grow'>
                    ...
                    <p className='text-sm w-[250px] text-center md:text-lg md:w-[300px] text-gray-700 font-semibold'>
                        You are not at the required location to fill out this
                        form.
                    </p>
                </div>
            )}
