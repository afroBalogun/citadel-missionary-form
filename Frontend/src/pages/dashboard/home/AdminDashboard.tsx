...
export default function AdminDashboard(){
    ...
    const uniqueMemberCount = getUniqueMemberCount(data || []);  
    ...
    const cards = cardItems.map((item, index) => {
        return (
            <div key={index} className="w-full flex flex-col gap-2 border-2 border-grey-300 text-gray-800 p-4 rounded-lg hover:shadow-md hover:-translate-y-1 hover:cursor-pointer transition-all duration-200">
